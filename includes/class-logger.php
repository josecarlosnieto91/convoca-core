...
class Logger
{
    ...
    public static function log(string $message, string $level = 'info', string $context = 'General', ?int $object_id = null): void
    {
        ...
        // Rate limiting
        $now = time();
        self::$log_timestamps = array_filter(self::$log_timestamps, function($t) use ($now) {
    ...
    public static function cleanup(): void
    {
        ...
        do {
            ...
            if ($affected) $total_deleted += $affected;
    ...
    public static function get_stats(): array
    {
        ...
        if (!self::table_exists()) {
            return ['total' => 0, 'by_level' => [], 'by_context' => [], 'size_kb' => 0];
        }
