...
class Blocks_Common
{
    public static function init()
    {
        ...
        add_filter('block_categories_all', [__CLASS__, 'add_custom_categories'], 1, 2);
    }
    ...
    public static function add_custom_categories($categories, $post)
    {
        ...
        $filtered = array_filter($new_categories, function($cat) use ($existing_slugs) {
    ...
    {
        register_block_type('biodevas-common/post-meta-field', [
            'apiVersion'      => 3,
            ...
            'render_callback' => [__CLASS__, 'render_post_meta_field'],
        ]);
    }
