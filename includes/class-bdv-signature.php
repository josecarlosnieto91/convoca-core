...
class BDV_Signature {
     ...
     */
    public function generate_pdf($template_content, $data, $output_path, $options = []) {
        $this->last_error = '';
        ...
        $html_safe_keys = apply_filters('bdv_pdf_html_safe_keys', [
            'dynamic_fields', 
            'declaracion', 
            'funciones', 
            'obligaciones', 
        ...
        $pdf_allowed_html = apply_filters('bdv_pdf_allowed_html', [
            'p'      => ['style' => []],
            'br'     => [],
            'strong' => ['style' => []],
            'b'      => ['style' => []],
